...
##go to the directory
cd /fp/projects01/ec31/mathelier-group/pascalo/scBasset_internship/results_scbasset/promotor_patient/processed/
##test
...
python /fp/projects01/ec31/mathelier-group/pascalo/scBasset_internship/code_scbasset/source/scbasset_train.py --input_folder chr_exclusion_filtered/  --epochs  1000 --out_path ../../../results_scbasset/promotor_patient/model
